...
import (
	"context"
	foov1alpha1 "my-operator/pkg/custom/apis/foo/v1alpha1"
	versioned "my-operator/pkg/custom/client/clientset/versioned"
	internalinterfaces "my-operator/pkg/custom/client/informers/externalversions/internalinterfaces"
	v1alpha1 "my-operator/pkg/custom/client/listers/foo/v1alpha1"
	time "time"
