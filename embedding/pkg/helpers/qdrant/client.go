...
const QdrantAddr = "localhost:6334"
...
// 获取 Collection 的信息
func (qc *QdrantClient) GetCollection(collectionName string) (*pb.GetCollectionInfoResponse, error) {
	cc := pb.NewCollectionsClient(qc.grpcConn)
	return cc.Get(context.Background(), &pb.GetCollectionInfoRequest{
