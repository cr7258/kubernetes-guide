...
var tasksResource = schema.GroupVersionResource{Group: "api.jtthink.com", Version: "v1alpha1", Resource: "tasks"}

var tasksKind = schema.GroupVersionKind{Group: "api.jtthink.com", Version: "v1alpha1", Kind: "Task"}
